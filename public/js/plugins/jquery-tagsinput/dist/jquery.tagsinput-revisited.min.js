...
!function (a) {
    ...
    a.fn.addTag = function (g, h) {
        return h = jQuery.extend({focus: !1, callback: !0}, h), this.each(function () {
            ...
            if (a("<span>").addClass("tag").append(a("<span>").text(g), a("<a>", {href: "#"}).click(function () {
        ...
        return this.each(function () {
            if ("undefined" == typeof a(this).data("tagsinput-init")) {
                ...
                i.interactive && (l = l + '<input id="' + f + '_tag" value="" placeholder="' + i.placeholder + '">'), a(l).insertAfter(this), a(k.holder).css("width", i.width), a(k.holder).css("min-height", i.height), a(k.holder).css("height", i.height), "" !== a(k.real_input).val() && a.fn.tagsInput.importTags(a(k.real_input), a(k.real_input).val()), i.interactive && (a(k.fake_input).val(""), a(k.fake_input).data("pasted", !1), a(k.fake_input).on("focus", k, function (b) {
