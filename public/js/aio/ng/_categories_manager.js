	...
	app.directive('categoryItem', function($compile,$rootScope,$http) {
		return {
			...
			template: `<li class="list-group-item" id="cat-item-<%cat.id%>" parent-category="<% cat.parent_category_id %>">
				...
				<i class="admin-icons icons-main-category" ng-if="cat.parent_category_id==0 || cat.parent_category_id==null"></i>
				<i class="admin-icons icons-plus-circle" ng-if="(cat.parent_category_id!=0 && cat.parent_category_id!=null && cat.categorires.length>0) && !opened"></i>
				<i class="admin-icons icons-minis-circle" ng-if="(cat.parent_category_id!=0 && cat.parent_category_id!=null && cat.categorires.length==0) || ((cat.parent_category_id!=0 && cat.parent_category_id!=null && cat.categorires.length>0) && opened)"></i>
				</a>
				</li>
